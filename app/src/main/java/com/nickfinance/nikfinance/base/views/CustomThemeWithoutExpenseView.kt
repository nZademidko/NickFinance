...
import com.nickfinance.nikfinance.base.views.builders.ClickState
import com.nickfinance.nikfinance.base.views.builders.RootState
...
class CustomThemeWithoutExpenseView(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs) {
    ...
    init {
        ...
        inflate(context, R.layout.view_custom_theme_without_expense, this)
    ...
    fun initUI(builder: ViewThemeWithoutExpenseBuilder) {
